...
ENTRYPOINT ["java", "-Dotel.exporter=jaeger", "-Dotel.exporter.jaeger.endpoint=http://jaeger:14250", "-Dotel.exporter.jaeger.service.name=workflow-engine", "-Dapplication.name=tp-workflow-engine", "-jar","/home/spring/app/bin/tp-workflow-engine-1.2.0.jar"]
EXPOSE 8080
