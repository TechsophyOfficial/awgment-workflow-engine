...
import static com.techsophy.tsf.workflow.engine.camunda.constants.ErrorMessageConstants.TOKEN_VERIFICATION_FAILED;
...
public class JWTRoleConverter implements Converter<Jwt, Collection<GrantedAuthority>>
{
    ...
    public Collection<GrantedAuthority> convert(Jwt jwt)
    {
        ...
        String userInfoResponse = webClientWrapper.webclientRequest(client,keyCloakApi+tokenUtils.getIssuerFromToken(jwt.getTokenValue())+USER_INFO_URL, HttpMethod.GET,null);
