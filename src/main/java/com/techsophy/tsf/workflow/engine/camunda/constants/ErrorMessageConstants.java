...
{
    public static final String INVALID_TOKEN = "AWGMENT-WORKFLOW-ENGINE-1018";
    public static final String AUTHENTICATION_FAILED= "AWGMENT-WORKFLOW-ENGINE-1019";
    public static final String UNABLE_GET_TOKEN= "AWGMENT-WORKFLOW-ENGINE-1020";
    public static final String TOKEN_VERIFICATION_FAILED= "AWGMENT-WORKFLOW-ENGINE-1021";
